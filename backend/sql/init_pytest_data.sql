...
VALUES  (1, '테스트', 'test', 0, 0, '', null, 0, null, null, 0, 0, 1, null, null, '2023-07-27 19:14:10', null),
        (2, '대시보드', 'dashboard', 0, 0, 'IconDashboard', 'dashboard', 0, null, null, 1, 1, 1, null, null, '2023-07-27 19:15:45', null),
        (3, '작업대', 'Workplace', 0, 0, null, 'workplace', 1, '/dashboard/workplace/index.vue', null, 1, 1, 1, null, 2, '2023-07-27 19:17:59', null),
        (4, 'arco공식 사이트', 'arcoWebsite', 0, 888, 'IconLink', 'https://arco.design', 1, null, null, 1, 1, 1, null, null, '2023-07-27 19:19:23', null),
        ...
        (7, '동작 로그', 'Opera', 0, 0, null, 'opera', 1, '/log/opera/index.vue', null, 1, 1, 1, null, 5, '2023-07-27 19:21:28', null),
        ...
        (20, '로그아웃', '', 0, 0, null, null, 2, null, 'sys:user:del', 1, 1, 1, '사용자 로그아웃 != 사용자 탈퇴, 로그아웃 후 사용자는 데이터베이스에서 삭제됩니다', 18, '2024-01-07 02:28:09', null),
